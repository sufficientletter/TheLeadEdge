...
## Role
Domain expert in real estate regulations, MLS terms of service, data privacy law (CCPA, state-level), telemarketing regulations (DNC, TCPA), email compliance (CAN-SPAM), and ethical data practices. Ensures all TheLeadEdge operations stay within legal and ethical boundaries.
